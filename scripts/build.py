...
<button class="btn btn-sm btn-bags-B bags-btn active" data-grade="B">B</button>
<button class="btn btn-sm btn-bags-C bags-btn active" data-grade="C">C</button>
<button class="btn btn-sm btn-bags-D bags-btn active" data-grade="D">D</button>
<button class="btn btn-sm btn-bags-E bags-btn active" data-grade="E">E</button>
<button class="btn btn-sm btn-bags-F bags-btn active" data-grade="F">F</button>
</div></div>
<div class="mb-3">
...
<select id="filterPantheonAssemblage" class="form-select form-select-sm mt-2"><option value="">All species</option><option value="__any__">Any PANTHEON assemblage</option></select>
</div>
<div class="mb-3">
...
function applyFilters() {
    ...
    filteredData = DATA.filter(row => {
        ...
        if (filters.pantheonAssemblage === '__any__') {
            if (!(row.pantheon_specific_assemblage_type || '').trim()) return false;
        } else if (filters.pantheonAssemblage) {
...
function updateActiveFiltersDisplay(filters) {
    ...
    if (filters.pantheonAssemblage) {
        const pantheonLabel = filters.pantheonAssemblage === '__any__' ? 'Any assemblage' : filters.pantheonAssemblage;
        addTag('PANTHEON', pantheonLabel, "document.getElementById('filterPantheonAssemblage').value='';applyFilters()");
    }
...
$(document).ready(function() {
    ...
    document.querySelectorAll('.bags-btn').forEach(btn=>{
        ...
        btn.addEventListener('click', toggleGrade);
    });
